...
出荷指示画面から、対象データの出荷指示一覧（Excel形式）を出力することができます。

### 操作手順

1. メニューから **「希望数管理」＞「出荷指示」** を開く
2. 絞り込み条件で必要な条件を入力し、「ダウンロード」ボタンをクリック
3. 帳票種類の「出荷表示一覧」を選んでダウンロードをクリック
4. Excelファイルがダウンロードされます
...
- **メモ / 伝票用メモ**
- **寄附者氏名**（配送先氏名等）
- **その他**（製造番号、出荷依頼日、数量など、画面上に表示されている項目）

> [!NOTE]
> ダウンロードしたExcelファイルの内容については、運用に合わせて適宜変更・加工してご使用いただけます。
...
1. 「出荷実績取込」画面を開く
2. ふるさと納税doから取得した出荷実績CSVを選択してアップロード
3. 取込結果が画面に表示される

<!-- TODO: 画像挿入 — 出荷実績取込画面 -->
![出荷実績取込画面](../asset/役所import2.png)
